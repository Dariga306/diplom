                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Text('Winter Vibes Night', style: GoogleFonts.outfit(
                            fontSize: 24, fontWeight: FontWeight.w800, color: AppColors.text, letterSpacing: -0.02 * 24)),
                        Text('Hosted by Aigerim', style: GoogleFonts.outfit(fontSize: 13, color: AppColors.text2)),
                      ]),
